...
MESSIER_DATA = {
    ...
    2: [T["AG"], "NGC 7089", "Verseau", "6.3", "16'", "Amas du Verseau", 21.56, -0.8],
    3: [T["AG"], "NGC 5272", "Ch. de Chasse", "6.2", "18'", "Amas des Chiens de Chasse", 13.7, 28.4],
    4: [T["AG"], "NGC 6121", "Scorpion", "5.9", "36'", "Amas du Scorpion", 16.4, -26.5],
    5: [T["AG"], "NGC 5904", "Serpent", "5.7", "23'", "Amas du Serpent", 15.31, 2.1],
    6: [T["AO"], "NGC 6405", "Scorpion", "4.2", "25'", "Amas du Papillon", 17.67, -32.2],
    7: [T["AO"], "NGC 6475", "Scorpion", "3.3", "80'", "Amas de Ptolémée", 17.89, -34.8],
    8: [T["N"], "NGC 6523", "Sagittaire", "6.0", "90'x40'", "Nébuleuse de la Lagune", 18.06, -24.4],
    9: [T["AG"], "NGC 6333", "Ophiuchus", "7.7", "11'", "Amas d'Ophiuchus", 17.32, -18.5],
    10: [T["AG"], "NGC 6254", "Ophiuchus", "6.6", "20'", "Amas d'Ophiuchus", 16.95, -4.1],
    11: [T["AO"], "NGC 6705", "Écu", "5.8", "14'", "Amas du Canard Sauvage", 18.85, -6.3],
    12: [T["AG"], "NGC 6218", "Ophiuchus", "6.7", "16'", "Amas d'Ophiuchus", 16.79, -1.9],
    13: [T["AG"], "NGC 6205", "Hercule", "5.8", "20'", "Grand Amas d'Hercule", 16.69, 36.5],
    14: [T["AG"], "NGC 6402", "Ophiuchus", "7.6", "11'", "Amas d'Ophiuchus", 17.62, -3.3],
    15: [T["AG"], "NGC 7078", "Pégase", "6.2", "18'", "Amas de Pégase", 21.5, 12.2],
    ...
    18: [T["AO"], "NGC 6613", "Sagittaire", "7.5", "9'", "Cygne Noir", 18.33, -17.1],
    19: [T["AG"], "NGC 6273", "Ophiuchus", "6.8", "17'", "Amas d'Ophiuchus", 17.04, -26.3],
    20: [T["N"], "NGC 6514", "Sagittaire", "6.3", "28'", "Nébuleuse Trifide", 18.04, -23.0],
    21: [T["AO"], "NGC 6531", "Sagittaire", "6.5", "13'", "Amas du Sagittaire", 18.08, -22.5],
    22: [T["AG"], "NGC 6656", "Sagittaire", "5.1", "32'", "Grand Amas du Sagittaire", 18.6, -23.9],
    23: [T["AO"], "NGC 6494", "Sagittaire", "6.9", "27'", "Amas du Sagittaire", 17.95, -19.0],
    24: [T["NS"], "NGC 6603", "Sagittaire", "4.6", "90'", "Petit Nuage Stellaire du Sagittaire", 18.28, -18.4],
    25: [T["AO"], "IC 4725", "Sagittaire", "4.6", "32'", "Amas du Sagittaire", 18.53, -19.2],
    26: [T["AO"], "NGC 6694", "Écu", "8.0", "15'", "Amas de l'Écu", 18.75, -9.4],
    27: [T["NP"], "NGC 6853", "Petit Renard", "7.4", "8'x6'", "Nébuleuse Dumbbell", 19.99, 22.7],
    28: [T["AG"], "NGC 6626", "Sagittaire", "6.8", "11'", "Amas du Sagittaire", 18.41, -24.9],
    29: [T["AO"], "NGC 6913", "Cygne", "7.1", "7'", "Amas du Cygne", 20.4, 38.5],
    30: [T["AG"], "NGC 7099", "Capricorne", "7.2", "12'", "Amas du Capricorne", 21.67, -23.2],
    ...
    34: [T["AO"], "NGC 1039", "Persée", "5.2", "35'", "Amas de Persée", 2.7, 42.8],
    35: [T["AO"], "NGC 2168", "Gémeaux", "5.1", "28'", "Amas des Gémeaux", 6.15, 24.3],
    36: [T["AO"], "NGC 1960", "Cocher", "6.0", "12'", "Amas du Cocher", 5.6, 34.1],
    37: [T["AO"], "NGC 2099", "Cocher", "5.6", "24'", "Amas du Cocher", 5.87, 32.5],
    38: [T["AO"], "NGC 1912", "Cocher", "6.4", "21'", "Amas de l'Étoile de Mer", 5.47, 35.8],
    39: [T["AO"], "NGC 7092", "Cygne", "4.6", "32'", "Amas du Cygne", 21.54, 48.4],
    40: [T["D"], "WNC 4", "Grande Ourse", "8.4", "0.8'", "Winnecke 4", 12.37, 58.1],
    41: [T["AO"], "NGC 2287", "Grand Chien", "4.5", "38'", "Amas du Petit Rucher", 6.78, -20.7],
    ...
    44: [T["AO"], "NGC 2632", "Cancer", "3.1", "95'", "Amas de la Crèche", 8.67, 19.7],
    45: [T["AO"], "NGC 1432", "Taureau", "1.6", "110'", "Les Pléiades", 3.78, 24.1],
    46: [T["AO"], "NGC 2437", "Poupe", "6.1", "27'", "Amas de la Poupe", 7.7, -14.8],
    47: [T["AO"], "NGC 2422", "Poupe", "4.4", "30'", "Amas de la Poupe", 7.61, -14.4],
    48: [T["AO"], "NGC 2548", "Hydre", "5.8", "54'", "Amas de l'Hydre", 8.23, -5.8],
    49: [T["G"], "NGC 4472", "Vierge", "8.4", "10'x9'", "Galaxie de la Vierge", 12.5, 8.0],
    50: [T["AO"], "NGC 2323", "Licorne", "5.9", "16'", "Amas de la Licorne", 7.05, -8.3],
    51: [T["G"], "NGC 5194", "Ch. de Chasse", "8.4", "11'x7'", "Galaxie du Tourbillon", 13.5, 47.2],
    52: [T["AO"], "NGC 7654", "Cassiopée", "6.9", "13'", "Amas de Cassiopée", 23.4, 61.6],
    53: [T["AG"], "NGC 5024", "Chevelure", "7.6", "13'", "Amas de la Chevelure", 13.21, 18.2],
    54: [T["AG"], "NGC 6715", "Sagittaire", "7.6", "12'", "Amas du Sagittaire", 18.92, -30.5],
    55: [T["AG"], "NGC 6809", "Sagittaire", "6.3", "19'", "Amas du Sagittaire", 19.67, -30.9],
    56: [T["AG"], "NGC 6779", "Lyre", "8.3", "9'", "Amas de la Lyre", 19.28, 33.0],
    ...
    62: [T["AG"], "NGC 6266", "Ophiuchus", "6.5", "15'", "Amas d'Ophiuchus", 17.02, -30.1],
    ...
    67: [T["AO"], "NGC 2682", "Cancer", "6.1", "30'", "Amas du Cobra Royal", 8.85, 11.8],
    68: [T["AG"], "NGC 4590", "Hydre", "7.8", "11'", "Amas de l'Hydre", 12.66, -26.7],
    69: [T["AG"], "NGC 6637", "Sagittaire", "7.6", "10'", "Amas du Sagittaire", 18.52, -32.3],
    70: [T["AG"], "NGC 6681", "Sagittaire", "7.9", "9'", "Amas du Sagittaire", 18.72, -32.3],
    71: [T["AG"], "NGC 6838", "Flèche", "8.2", "7'", "Amas de la Flèche", 19.89, 18.8],
    72: [T["AG"], "NGC 6981", "Verseau", "9.3", "7'", "Amas du Verseau", 20.89, -12.5],
    ...
    75: [T["AG"], "NGC 6864", "Sagittaire", "8.5", "7'", "Amas du Sagittaire", 20.1, -21.9],
    ...
    79: [T["AG"], "NGC 1904", "Lièvre", "7.7", "10'", "Amas du Lièvre", 5.41, -24.5],
    80: [T["AG"], "NGC 6093", "Scorpion", "7.3", "10'", "Amas du Scorpion", 16.28, -22.9],
    ...
    92: [T["AG"], "NGC 6341", "Hercule", "6.3", "14'", "Amas d'Hercule", 17.28, 43.1],
    93: [T["AO"], "NGC 2447", "Poupe", "6.0", "22'", "Amas de la Poupe", 7.74, -23.9],
    ...
    103: [T["AO"], "NGC 581", "Cassiopée", "7.4", "6'", "Amas de Cassiopée", 1.55, 60.7],
    ...
    107: [T["AG"], "NGC 6171", "Ophiuchus", "7.9", "13'", "Amas d'Ophiuchus", 16.54, -13.1],
...
CALDWELL_DATA = {
    1: [T["AO"], "NGC 188", "Céphée", "8.1", "13'", "NGC 188", 0.74, 85.3],
    ...
    8: [T["AO"], "NGC 559", "Cassiopée", "7.1", "5.8'", "NGC 559", 1.49, 63.3],
    9: [T["EN"], "Sh2-155", "Céphée", "-", "50'x40'", "Nébuleuse de la Grotte", 22.95, 62.3],
    10: [T["AO"], "NGC 663", "Cassiopée", "7.1", "16'", "NGC 663", 1.77, 61.2],
    ...
    13: [T["AO"], "NGC 457", "Cassiopée", "6.7", "13'", "Amas de la Chouette", 1.32, 58.3],
    14: [T["AO"], "NGC 869", "Persée", "4.4", "30'", "Double Amas de Persée", 2.32, 57.1],
    15: [T["NP"], "NGC 6826", "Cygne", "9.8", "30''", "Nébuleuse de l'Œil Clignotant", 19.75, 50.5],
    16: [T["AO"], "NGC 7243", "Lézard", "6.4", "20'", "NGC 7243", 22.25, 49.9],
    ...
    25: [T["AG"], "NGC 2419", "Lynx", "10.4", "4'", "Amas de l'Errant Intergalactique", 7.63, 38.9],
    ...
    28: [T["AO"], "NGC 752", "Andromède", "5.2", "45'", "NGC 752", 1.96, 37.8],
    ...
    37: [T["AO"], "NGC 6885", "Petit Renard", "6.0", "14'", "NGC 6885", 20.2, 26.5],
    ...
    41: [T["AO"], "Mel 25", "Taureau", "0.5", "330'", "Les Hyades", 4.45, 15.9],
    42: [T["AG"], "NGC 7006", "Dauphin", "10.6", "3'", "NGC 7006", 21.02, 16.2],
    ...
    54: [T["AO"], "NGC 2506", "Licorne", "7.6", "14'", "NGC 2506", 8.0, -10.8],
    ...
    58: [T["AO"], "NGC 2360", "Grand Chien", "7.2", "20'", "Amas de Caroline", 7.3, -15.6],
    ...
    64: [T["AO"], "NGC 2362", "Grand Chien", "4.1", "20'", "NGC 2362", 7.31, -24.9],
    65: [T["G"], "NGC 253", "Sculpteur", "7.1", "25'x7'", "Galaxie du Sculpteur", 0.79, -25.3],
    66: [T["AG"], "NGC 5694", "Hydre", "8.5", "2'", "NGC 5694", 14.66, -26.5],
    ...
    71: [T["AO"], "NGC 2477", "Poupe", "4.2", "27'", "NGC 2477", 7.87, -38.5],
    72: [T["G"], "NGC 55", "Sculpteur", "7.8", "31'x6'", "NGC 55", 0.25, -39.2],
    73: [T["AG"], "NGC 1851", "Colombe", "7.3", "11'", "NGC 1851", 5.24, -40.1],
    74: [T["NP"], "NGC 3132", "Voiles", "8.2", "1'", "Nébuleuse du Huit Éclatant", 10.12, -40.4],
    75: [T["AO"], "NGC 6124", "Loup", "5.8", "40'", "NGC 6124", 16.42, -40.7],
    76: [T["AO"], "NGC 6231", "Scorpion", "2.6", "15'", "NGC 6231", 16.9, -41.8],
    77: [T["G"], "NGC 5128", "Centaure", "6.8", "18'x14'", "Centaurus A", 13.42, -43.0],
    78: [T["AG"], "NGC 5139", "Centaure", "3.7", "36'", "Omega Centauri", 13.45, -47.5],
    79: [T["AO"], "NGC 4755", "Croix du Sud", "4.2", "10'", "La Boîte à Bijoux", 12.89, -60.3],
    80: [T["AG"], "NGC 5139", "Centaure", "3.7", "36'", "Omega Centauri bis", 13.45, -47.5],
    81: [T["AG"], "NGC 6352", "Autel", "8.1", "6'", "NGC 6352", 17.42, -48.4],
    82: [T["AG"], "NGC 6362", "Autel", "8.1", "12'", "NGC 6362", 17.53, -67.0],
    83: [T["G"], "NGC 4945", "Centaure", "8.6", "13'x4'", "NGC 4945", 13.09, -49.5],
    84: [T["AG"], "NGC 5286", "Centaure", "7.4", "10'", "NGC 5286", 13.77, -51.4],
    85: [T["AO"], "IC 2391", "Voiles", "2.5", "50'", "IC 2391", 8.67, -53.0],
    86: [T["AG"], "NGC 6397", "Autel", "5.3", "30'", "NGC 6397", 17.68, -53.7],
    87: [T["AG"], "NGC 1261", "Horloge", "8.4", "7'", "NGC 1261", 3.2, -55.2],
    88: [T["AO"], "NGC 5823", "Compas", "9.1", "11'", "NGC 5823", 15.09, -55.6],
    89: [T["AO"], "NGC 6067", "Règle", "5.1", "14'", "NGC 6067", 16.22, -54.2],
    90: [T["NP"], "NGC 2867", "Carène", "10.9", "18''", "NGC 2867", 9.36, -58.3],
    91: [T["AO"], "NGC 3532", "Carène", "3.9", "41'", "NGC 3532", 11.11, -58.7],
    92: [T["EN"], "NGC 3372", "Carène", "-", "120'", "Nébuleuse d'Eta Carinae", 10.75, -59.7],
    93: [T["AG"], "NGC 6752", "Paon", "5.4", "27'", "NGC 6752", 19.18, -59.9],
    94: [T["AO"], "NGC 4755", "Croix du Sud", "4.2", "10'", "La Boîte à Bijoux", 12.89, -60.3],
    95: [T["AO"], "NGC 6025", "Triangle Austral", "5.1", "12'", "NGC 6025", 16.03, -60.5],
    96: [T["AO"], "NGC 2516", "Carène", "3.8", "30'", "NGC 2516", 7.97, -60.8],
    97: [T["AO"], "NGC 3766", "Centaure", "3.9", "12'", "NGC 3766", 11.6, -61.5],
    98: [T["AO"], "NGC 4609", "Croix du Sud", "4.1", "5'", "NGC 4609", 12.71, -61.0],
    ...
    102: [T["AO"], "IC 2602", "Carène", "1.9", "100'", "Pléiades du Sud", 10.72, -64.4],
    103: [T["EN"], "NGC 2070", "Dorade", "-", "40'", "Nébuleuse de la Tarentule", 5.65, -69.1],
    104: [T["AG"], "NGC 47", "Toucan", "4.0", "31'", "NGC 47", 0.4, -72.1],
    105: [T["AG"], "NGC 4833", "Mouche", "7.8", "14'", "NGC 4833", 12.99, -70.9],
    106: [T["AG"], "NGC 104", "Toucan", "4.0", "31'", "47 Tucanae", 0.4, -72.1],
    107: [T["AG"], "NGC 6101", "Oiseau de Paradis", "9.2", "10'", "NGC 6101", 16.43, -72.2],
    108: [T["AG"], "NGC 4372", "Mouche", "7.2", "20'", "NGC 4372", 12.43, -73.0],
...
RASC_DATA = {
    ...
    5: [T["AO"], "NGC 7789", "Cassiopée", "6.7", "16'", "Amas de la Rose Blanche", 23.95, 56.7],
    ...
    8: [T["AO"], "NGC 457", "Cassiopée", "6.4", "13'", "Amas de la Chouette", 1.32, 58.3],
    9: [T["AO"], "NGC 663", "Cassiopée", "7.1", "16'", "Amas de l'Écharpe (Scarf Cluster)", 1.77, 61.2],
    ...
    17: [T["AO"], "NGC 869", "Persée", "4.4", "30'/30'", "Double Amas de Persée", 2.32, 57.1],
    ...
    29: [T["AO"], "NGC 2194", "Orion", "8.5", "10'", "Amas ouvert", 6.23, 12.8],
    ...
    36: [T["AO"], "NGC 2539", "Poupe", "6.5", "22'", "Amas ouvert", 8.18, -12.8],
    ...
    86: [T["AG"], "NGC 5466", "Bouvier", "9.1", "11.0'", "Amas globulaire", 14.09, 28.5],
    ...
    93: [T["AO"], "NGC 6633", "Ophiuchus", "4.6", "27'", "Amas de Tweedledum", 18.46, 6.5],
    94: [T["AG"], "NGC 6712", "Ecu de Sobieski", "8.2", "7.2'", "Amas globulaire", 18.89, -8.7],
    95: [T["NP"], "NGC 6781", "Aigle", "11.8", "1'49''", "Phantom Feather Nebula", 19.31, 6.5],
    96: [T["AO"], "NGC 6819", "Cygne", "7.3", "5'", "Amas de la Tête de Renard (Foxhead)", 19.69, 40.2],
    ...
    103: [T["AO"], "NGC 6520", "Sagittaire", "8.1", "6'", "Amas ouvert", 18.06, -27.9],
    104: [T["NP"], "NGC 6818", "Sagittaire", "9.9", "17''", "Little Gem Nebula", 19.73, -16.2],
    105: [T["AO"], "NGC 6802", "Petit Renard", "8.8", "3.2'", "Amas ouvert", 19.51, 20.3],
    106: [T["AO"], "NGC 6940", "Petit Renard", "6.3", "31'", "Amas ouvert", 20.58, 28.3],
    107: [T["AO"], "NGC 6939", "Céphée", "7.8", "8'", "Amas ouvert", 20.57, 60.6],
...
O_MEARA_DATA = {
    # hidden treasures
    1: [T["AO"], "NGC 189", "Cassiopée", "8.8", "5'", "NGC 189", 0.38, 61.1],
    2: [T["AO"], "Amas du Voilier", "Cassiopée", "7.0", "15'", "Amas du Voilier", 0.73, 61.8],
    3: [T["N"], "NGC 281", "Cassiopée", "7.8", "30'x35'", "Nébuleuse Pacman", 0.87, 56.6],
    4: [T["AG"], "NGC 288", "Sculpteur", "8.1", "13'", "NGC 288", 0.88, -26.6],
    ...
    7: [T["AO"], "NGC 659", "Cassiopée", "7.9", "6'", "Amas Ying Yang", 1.77, 60.7],
    ...
    14: [T["AO"], "Alpha Per", "Persée", "1.2", "185'", "Amas d'Alpha Persei", 3.40, 49.0],
    ...
    23: [T["AO"], "NGC 1502", "Girafe", "6.0", "20'", "Amas du Jolly Roger", 4.13, 62.3],
    24: [T["NP"], "NGC 1535", "Éridan", "9.6", "0.9'", "Œil de Cléopâtre", 4.24, -12.7],
    25: [T["AO"], "NGC 1528", "Persée", "6.4", "18'", "Amas m & m", 4.25, 51.2],
    26: [T["AO"], "NGC 1545", "Persée", "6.2", "12'", "Amas m & m", 4.30, 50.3],
    27: [T["AO"], "NGC 1647", "Taureau", "6.4", "40'", "Amas de la Lune Pirate", 4.77, 19.1],
    28: [T["NP"], "IC 418", "Lièvre", "9.6", "0.5'", "Nébuleuse de la Framboise", 5.10, -12.7],
    29: [T["AO"], "Cr 69", "Orion", "5.0", "50'", "Amas de Lambda Orionis", 5.58, 9.9],
    30: [T["AO"], "NGC 1981", "Orion", "4.2", "28'", "Amas du Wagon de Charbon", 5.59, -4.4],
    31: [T["AO"], "NGC 1980", "Orion", "5.0", "30'", "Le Joyau Perdu d'Orion", 5.59, -4.9],
    ...
    36: [T["AO"], "NGC 2169", "Orion", "5.9", "6'", "Amas des Petites Pléiades", 6.36, 14.0],
    37: [T["N"], "NGC 2175", "Orion", "6.9", "18'", "NGC 2175", 6.38, 20.5],
    38: [T["AO"], "NGC 2264", "Licorne", "4.1", "40'", "Amas de l'Arbre de Noël", 6.68, 9.9],
    39: [T["AO"], "NGC 2301", "Licorne", "6.0", "15'", "Le Dragon d'Hagrid", 6.86, 0.5],
    40: [T["AO"], "NGC 2353", "Licorne", "7.1", "18'", "Avery's Island", 7.24, -10.3],
    41: [T["NP"], "NGC 2440", "Poupe", "9.4", "1.3'", "Nébuleuse du Papillon Albinos", 7.70, -18.2],
    42: [T["AO"], "NGC 2451", "Poupe", "2.8", "50'", "Amas du Scorpion Piquant", 7.75, -38.0],
    43: [T["N"], "NGC 2467", "Poupe", "7.1", "15'", "NGC 2467", 7.87, -26.4],
    44: [T["AO"], "NGC 2547", "Voiles", "4.7", "25'", "Amas de la Boucle d'Oreille d'Or", 8.17, -49.2],
    45: [T["AO"], "NGC 2539", "Poupe", "6.5", "15'", "Amas de l'Assiette", 8.18, -12.8],
    46: [T["AO"], "NGC 2546", "Poupe", "6.3", "70'", "Amas du Cœur et de la Dague", 8.20, -37.6],
    ...
    50: [T["AO"], "IC 2488", "Voiles", "7.0", "15'", "Amas du Collier de Perles", 9.77, -57.0],
    ...
    53: [T["AO"], "NGC 3228", "Voiles", "6.0", "5'", "Amas du Trésor de la Reine", 10.36, -51.7],
    54: [T["AO"], "NGC 3293", "Carène", "4.7", "5'", "Petite Boîte à Bijoux", 10.58, -58.2],
    ...
    62: [T["AO"], "Mel 111", "Chevelure de Bérénice", "1.8", "300'", "Amas de Coma", 12.42, 25.9],
    ...
    71: [T["AO"], "NGC 5281", "Centaure", "5.9", "8'", "Amas du Petit Scorpion", 13.80, -62.9],
    72: [T["G"], "NGC 5363", "Vierge", "10.5", "4'x3'", "NGC 5363", 13.94, 5.3],
    73: [T["AO"], "NGC 5662", "Centaure", "5.5", "30'", "NGC 5662", 14.59, -56.7],
    ...
    76: [T["AG"], "NGC 5897", "Balance", "8.4", "11'", "Amas Globulaire Fantôme", 15.30, -21.0],
    77: [T["AG"], "NGC 5986", "Loup", "7.6", "10'", "NGC 5986", 15.77, -37.8],
    78: [T["NP"], "NGC 6210", "Hercule", "8.8", "0.4'", "Nébuleuse de la Tortue", 16.74, 23.8],
    79: [T["AO"], "NGC 6242", "Scorpion", "6.4", "9'", "NGC 6242", 16.92, -39.5],
    80: [T["AO"], "NGC 6281", "Scorpion", "5.4", "8'", "Amas de l'Aile de Papillon de Nuit", 17.01, -37.9],
    81: [T["NP"], "NGC 6369", "Ophiuchus", "11.4", "0.6'", "Nébuleuse du Petit Fantôme", 17.49, -23.8],
    82: [T["AO"], "NGC 6400", "Scorpion", "8.8", "12'", "Amas Fantôme", 17.67, -37.0],
    83: [T["AO"], "NGC 4665", "Ophiuchus", "8.3", "45'", "La Ruche d'Été", 17.66, 5.7],
    ...
    86: [T["AG"], "NGC 6441", "Scorpion", "7.2", "10'", "Amas de la Pépite d'Argent", 17.83, -37.1],
    87: [T["D"], "Barnard", "Ophiuchus", "9.5", "n/a", "Étoile de Barnard", 17.96, 4.7],
    88: [T["AO"], "NGC 6520", "Sagittaire", "7.6", "5'", "Le Coffre du Mort", 18.06, -27.9],
    89: [T["AG"], "NGC 6544", "Sagittaire", "7.5", "9'", "Amas de l'Étoile de Mer", 18.12, -25.0],
    90: [T["NP"], "NGC 6572", "Ophiuchus", "8.1", "0.3'", "Nébuleuse de l'Œil d'Émeraude", 18.20, 6.9],
    91: [T["AG"], "NGC 6624", "Sagittaire", "7.6", "9'", "NGC 6624", 18.39, -30.4],
    92: [T["AO"], "NGC 6633", "Ophiuchus", "4.6", "20'", "Amas de Tweedledum", 18.46, 6.5],
    93: [T["AO"], "IC 4756", "Serpent", "5.0", "52'", "Amas de Graff", 18.65, 5.4],
    94: [T["AO"], "NGC 6709", "Aigle", "6.7", "15'", "Amas de la Licorne Volante", 18.86, 10.3],
    95: [T["AG"], "NGC 6712", "Écu", "8.1", "10'", "NGC 6712", 18.88, -8.7],
    96: [T["AG"], "NGC 6723", "Sagittaire", "6.8", "13'", "NGC 6723", 18.99, -36.6],
    97: [T["A"], "Cr 399", "Petit Renard", "3.6", "60'", "Le Cintre", 19.42, 20.2],
    98: [T["AO"], "NGC 6819", "Cygne", "7.3", "5'", "Amas de la Tête de Renard", 19.69, 40.2],
    99: [T["NP"], "NGC 6818", "Sagittaire", "9.3", "0.8'", "Nébuleuse du Petit Joyau", 19.73, -14.2],
    100: [T["AO"], "NGC 6866", "Cygne", "7.6", "7'", "Amas de la Frégate Pirate", 20.06, 44.2],
    101: [T["AO"], "NGC 6940", "Petit Renard", "6.3", "25'", "Amas de Mothra", 20.58, 28.3],
    ...
    105: [T["AN"], "IC 1396", "Céphée", "3.5", "154'", "Amas de l'Éléphant / Trèfle", 21.65, 57.8],
    106: [T["AO"], "NGC 7380", "Céphée", "7.2", "20'", "Vif d'Or de Harry Potter", 22.78, 58.1],
    107: [T["A"], "Asterism", "Poissons", "8.0", "12'", "Petite Louche", 23.82, 8.0],
    108: [T["AO"], "NGC 7789", "Cassiopée", "6.7", "25'", "Amas de la Rose Rose (O'Meara)", 23.95, 56.7],
    ...
    1004: [T["AO"], "NGC 654", "Cassiopée", "7.9", "40'", "Amas ouvert avec nébulosité", 1.74, 61.8],
    1005: [T["AO"], "Collinder 463", "Cassiopée", "9.1", "57'", "Lund 57 / Loch Ness monster", 1.89, 71.9],
    1006: [T["AO"], "Stock 2", "Cassiopée", "4.4", "130'", "Strong Man Cluster", 2.25, 59.4],
    ...
    1009: [T["AO"], "NGC 1245", "Persée", "7.6", "10'", "Amas de l'Étoile de Mer", 3.24, 47.2],
    1010: [T["G"], "NGC 1300", "Éridan", "10.4", "6.5'", "Galaxie spirale barrée", 3.33, -19.4],
    1011: [T["AO"], "NGC 1342", "Persée", "8.1", "30'", "Amas de la Raie / Petit Scorpion", 3.53, 37.3],
    ...
    1018: [T["AO"], "NGC 1750", "Taureau", "7.0", "60'", "Amas ouvert", 5.06, 23.6],
    1019: [T["AO"], "NGC 1758", "Taureau", "7.0", "90'", "Amas ouvert", 5.07, 23.7],
    1020: [T["EN"], "NGC 1788", "Orion", "10.0", "8'", "Chauve-Souris Cosmique / Foxface", 5.13, -3.3],
    1021: [T["AO"], "NGC 1807", "Taureau", "7.0", "17'", "Amas ouvert", 5.20, 16.5],
    1022: [T["AO"], "NGC 1817", "Taureau", "7.7", "16'", "Amas ouvert", 5.21, 16.6],
    1023: [T["EN"], "IC 417", "Cocher", "10.0", "13'", "Nébuleuse de l'Araignée", 5.47, 34.4],
    1024: [T["AO"], "NGC 1931", "Cocher", "8.3", "3'", "La Mouche (avec IC 417)", 5.52, 34.2],
    1025: [T["AO"], "Collinder 70", "Orion", "0.4", "150'", "Ceinture d'Orion", 5.60, -1.0],
    ...
    1030: [T["AO"], "NGC 2281", "Cocher", "7.2", "15'", "Amas du Cœur Brisé", 6.81, 41.1],
    1031: [T["AG"], "NGC 2298", "Poupe", "7.3", "6.8'", "Amas Globulaire de la Poupe", 6.81, -36.0],
    1032: [T["EN"], "NGC 2316", "Licorne", "10.0", "4'", "Nébuleuse par émission", 7.02, -7.7],
    1033: [T["AO"], "NGC 2343", "Licorne", "5.5", "7'", "Amas ouvert", 7.14, -10.6],
    ...
    1037: [T["AO"], "NGC 2420", "Gémeaux", "9.1", "10'", "Amas de la Comète Scintillante", 7.64, 21.5],
    ...
    1052: [T["AG"], "NGC 4147", "Chevelure de Bérénice", "10.3", "4'", "Amas Kick the Can", 12.17, 18.5],
    ...
    1059: [T["G"], "NGC 4473", "Chevelure de Bérénice", "10.2", "4.5'", "Galaxie elliptique", 12.50, 13.4],
    1060: [T["G"], "NGC 4477", "Chevelure de Bérénice", "10.4", "4'", "Galaxie spirale", 12.50, 13.6],
    1061: [T["G"], "NGC 4636", "Vierge", "9.5", "6.2'", "Galaxie elliptique", 12.71, 2.6],
    1062: [T["G"], "NGC 4665", "Vierge", "10.5", "4.2'", "Galaxie spirale", 12.77, 3.0],
    1063: [T["G"], "NGC 4753", "Vierge", "10.5", "5.4'", "Galaxie lenticulaire", 12.87, -1.2],
    1064: [T["G"], "NGC 4762", "Vierge", "10.1", "8.7'", "Galaxie avec NGC 4754", 12.88, 11.2],
    1065: [T["G"], "NGC 5033", "Chiens de Chasse", "10.0", "11'", "Galaxie spirale", 13.22, 36.5],
    1066: [T["G"], "NGC 5195", "Chiens de Chasse", "10.0", "5.4'", "Compagne de M51 (Arp 85)", 13.50, 47.2],
    1067: [T["AG"], "NGC 5466", "Bouvier", "10.3", "11'", "Amas Globulaire Fantôme", 14.09, 28.5],
    1068: [T["G"], "NGC 5846", "Vierge", "10.5", "3.4'", "Galaxie spirale", 15.11, 1.6],
    1069: [T["G"], "NGC 5907", "Dragon", "10.1", "12'", "Galaxie de l'Éclat", 15.26, 56.3],
    1070: [T["NP"], "IC 4593", "Hercule", "11.4", "0.25'", "Nébuleuse du Petit Pois", 16.75, 12.0],
    1071: [T["AG"], "NGC 6144", "Scorpion", "9.0", "9.3'", "Amas Globulaire", 16.45, -26.0],
    1072: [T["G"], "NGC 6207", "Hercule", "11.5", "3'", "Galaxie proche de M13", 16.72, 36.8],
    1073: [T["AG"], "NGC 6229", "Hercule", "9.4", "4.5'", "Amas Globulaire d'Hercule", 16.78, 47.5],
    1074: [T["AG"], "NGC 6293", "Ophiuchus", "17.17", "7.9'", "Amas Globulaire", 17.17, -26.5],
    1075: [T["NP"], "NGC 6309", "Ophiuchus", "10.5", "0.75'", "Nébuleuse de la Boîte", 17.24, -12.9],
    1076: [T["AG"], "NGC 6356", "Ophiuchus", "9.5", "7.2'", "Amas Globulaire", 17.51, -17.8],
    1077: [T["AG"], "NGC 6522", "Sagittaire", "10.3", "90'", "Fenêtre de Baade", 18.05, -30.0],
    1078: [T["AG"], "NGC 6528", "Sagittaire", "10.0", "3.7'", "Amas Globulaire", 18.06, -30.0],
    1079: [T["NP"], "NGC 6563", "Sagittaire", "11.0", "1.5'", "Anneau Austral", 18.20, -33.8],
    1080: [T["RN"], "NGC 6589", "Sagittaire", "10.0", "5'", "Nébuleuse par réflexion", 18.28, -19.7],
    1081: [T["RN"], "NGC 6595", "Sagittaire", "10.0", "11'", "Nébuleuse par réflexion", 18.31, -19.8],
    1082: [T["AG"], "NGC 6638", "Sagittaire", "9.0", "5'", "Amas Globulaire", 18.52, -25.5],
    1083: [T["AO"], "NGC 6664", "Écu de Sobieski", "7.2", "16'", "Amas du Traîneau", 18.55, -8.2],
    1084: [T["AG"], "NGC 6717", "Sagittaire", "9.1", "3.9'", "Amas Globulaire (Palomar 9)", 18.92, -22.7],
    1085: [T["NP"], "NGC 6751", "Aigle", "11.5", "0.25'", "Nébuleuse de la Fleur de Pissenlit", 19.10, -5.9],
    1086: [T["AO"], "NGC 6755", "Aigle", "7.0", "90'", "Amas avec NGC 6756", 19.13, 4.2],
    1087: [T["AO"], "NGC 6756", "Aigle", "10.0", "4'", "Amas avec NGC 6755", 19.15, 4.7],
    1088: [T["NP"], "NGC 6778", "Aigle", "11.5", "1'", "Mini Dumbbell / Fils de M76", 19.31, -1.5],
    1089: [T["NP"], "NGC 6781", "Aigle", "11.5", "2'", "Nébuleuse de la Boule de Neige", 19.31, 6.5],
    1090: [T["NP"], "NGC 6804", "Aigle", "11.5", "1'", "Nébuleuse du Rétrécissement", 19.52, 9.2],
    1091: [T["AO"], "NGC 6811", "Cygne", "8.1", "13'", "Smoke Ring / Hole in a Cluster", 19.63, 46.3],
    1092: [T["A"], "Cygnus Kite Asterism", "Cygne", "10.0", "12'", "Astérisme du Cerf-Volant", 19.78, 47.5],
    1093: [T["NP"], "NGC 6891", "Dauphin", "11.5", "0.3'", "Nébuleuse planétaire", 20.25, 12.7],
    1094: [T["NP"], "NGC 6894", "Cygne", "10.0", "1'", "Petite Nébuleuse de l'Anneau", 20.27, 30.5],
    1095: [T["EN"], "IC 1318", "Cygne", "10.0", "0.1'", "Nébuleuse Gamma Cygni", 20.37, 40.2],
    1096: [T["NP"], "NGC 6905", "Dauphin", "10.9", "1'", "Nébuleuse de l'Éclair Bleu", 20.37, 20.1],
    1097: [T["AO"], "NGC 6910", "Cygne", "5.9", "8'", "Amas de l'Arpenteur (Inchworm)", 20.39, 40.7],
    1098: [T["AO"], "NGC 6939", "Céphée", "8.8", "8'", "Astérisme de l'Oie en vol", 20.53, 60.6],
    1099: [T["NP"], "NGC 7026", "Cygne", "10.7", "0.5'", "Nébuleuse du Cheeseburger", 21.14, 47.8],
    1100: [T["NP"], "NGC 7048", "Cygne", "10.0", "1'", "Nébuleuse du Disque Fantôme", 21.24, 46.2],
    1101: [T["RN"], "NGC 7129", "Céphée", "10.0", "8'", "Rose Cosmique", 21.71, 66.1],
    1102: [T["AO"], "NGC 7160", "Céphée", "6.1", "7'", "Alligator Nageur", 21.90, 62.6],
    1103: [T["AO"], "NGC 7209", "Lézard", "8.4", "40'", "Amas ouvert", 22.07, 46.4],
    1104: [T["NP"], "NGC 7354", "Céphée", "11.0", "0.7'", "Nébuleuse planétaire", 22.83, 61.2],
    1105: [T["AO"], "NGC 7510", "Céphée", "7.3", "4'", "Amas du Loir (Dormouse)", 23.18, 60.5],
    1106: [T["EN"], "NGC 7538", "Céphée", "10.0", "10'", "Nébuleuse de la Lagune Nord", 23.23, 61.5],
    1107: [T["AO"], "NGC 7788", "Cassiopée", "8.5", "17'", "Amas avec NGC 7788", 23.95, 61.2],
}
...
def generate():
    ...
    <body>
        ...
        <script>
            ...
            const FAMILIES = {{
                "Nébuleuse": ["{LANG['TYPES']['N']}", "{LANG['TYPES']['NP']}", "{LANG['TYPES']['NS']}", "{LANG['TYPES']['SNR']}", "{LANG['TYPES']['EN']}", "{LANG['TYPES']['RN']}", "{LANG['TYPES']['E/RN']}", "{LANG['TYPES']['AN']}"],
                "Galaxie": ["{LANG['TYPES']['G']}"],
                "Amas": ["{LANG['TYPES']['AG']}", "{LANG['TYPES']['AO']}", "{LANG['TYPES']['D']}", "{LANG['TYPES']['A']}", "{LANG['TYPES']['AN']}"]
            }};
